    ...
    <section id="achievements" className="py-28 bg-dark-900 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5 mb-24">
          {achievements.map((a) => (
            <div key={a.title} className="glass rounded-2xl p-5 glass-hover reveal border border-white/5">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {certifications.map((c) => (
            <div key={c.title} className="glass rounded-2xl p-5 glass-hover reveal border border-white/5 flex flex-col">
